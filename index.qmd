...
subtitle: "Analysis of Chicago taxis"
format:
  html:
    code-fold: true
    echo: true
...
```{r}
#| label: tip-col_chart
#| fig-cap: "Figure 1. Frequency of trips by tipping status, highlighting the significant class imbalance in the dataset."
...
#| warning: false
#| fig-cap: "Figure 2. Histogram of trip distances using a logarithmic x-axis to accommodate the right-skewed distribution."
...
#| fig-cap: "Figure 3. Comparative distribution of trip distances by tipping status, displaying the median, quartiles, and outliers."
# 1. Boxplot
...
#| fig-cap: "Figure 4. Tipping rates by company provider, ranked by performance and highlighting the market leader."
# 1. Data prep
...
#| fig-cap: "Figure 5. Temporal variation in tipping rates throughout the day, including the global average."
# 1. Data Prep
...
#| fig-cap: "Figure 6. Visual assessment of the model's discriminatory power."
# 3. Visualization: ROC
predictions |> 
...
```{r}
#| label: model-evaluation-3
#| fig-cap: "Figure 7. Heatmap of the Confusion Matrix."
...
#| fig-cap: "Figure 8. Forest plot displaying Odds Ratios with 95% CI. Predictors are statistically significant only if their error bars do not cross the neutral vertical line (OR = 1)."
